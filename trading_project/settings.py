...
SECRET_KEY = 'django-insecure-y+5)v1#c2*0^@b=l1mefax2@a0wo$pw9zmd*^mmfc7n+6+9ti_'
...
USE_L10N = True
DATETIME_FORMAT = 'M d, Y g:i A'  # 12-hour format with AM/PM
DATE_FORMAT = 'M d, Y'
TIME_FORMAT = 'g:i A'  # 12-hour format with AM/PM
SHORT_DATETIME_FORMAT = 'M d g:i A'
